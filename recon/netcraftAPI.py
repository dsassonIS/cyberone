...
def get_subdomains(domain):
    url = "http://searchdns.netcraft.com/?restriction=site+contains&host=." + domain + "&lookup=wait..&position=limited"
...
res = NetcraftAPI({'verbose': True}).search('.booking.com')
print res
'''
